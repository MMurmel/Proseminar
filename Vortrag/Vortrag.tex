...
\frametitle{\ff-Basisalgorithmus}
\begin{itemize}
\item maximaler Fluss wegen maxflow-mincut-Theorem \begin{itemize}
...
\item $\mathcal{O}(\lvert f_{max}\rvert(V + E))$ für einen maximalen Fluss $f_{max}$
\item Problem: schlechte Wegewahl möglich
\end{itemize}
\note{Tricks mit Datenstruktur -> ohne V in Komplexität}
