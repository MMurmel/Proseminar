...
\affil{Fakultät Informatik, TU Dresden}
\date{\today}
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.95\textwidth}
		...
		\end{tikzpicture}
		\caption{Initiale Konfiguration. Links sind Flussnetzwerk und Fluss zu sehen, rechts werden die Höhe der Knoten im Diagramm, sowie deren Flussüberschuss in rot aufgeführt.}
	\end{subfigure}
	\vskip\baselineskip
	\begin{subfigure}{0.95\textwidth}
		\centering
