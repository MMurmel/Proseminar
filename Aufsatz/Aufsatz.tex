...
\begin{figure}[p]
	...
	\begin{subfigure}{0.95\textwidth}
		...
		\end{tikzpicture}
		\caption{Initiale Konfiguration. Links sind Flussnetzwerk und Fluss zu sehen, rechts werden die Höhe der Knoten im Diagramm, sowie deren Flussüberschuss in rot ausgeführt.}
	\end{subfigure}
	\vskip\baselineskip
	\begin{subfigure}{0.95\textwidth}
		\centering
		...
		\begin{tikzpicture}[scale=0.50]
			...
			\draw (4,5.5) node[anchor=south, text=red] {\large 0};
		\end{tikzpicture}
		\caption{Nach Initialize-Preflow}
	\end{subfigure}
	\vskip\baselineskip
	\begin{subfigure}{0.95\textwidth}
		\centering
		...
		\begin{tikzpicture}[scale=0.50]
			...
			\draw (4,5.5) node[anchor=south, text=red] {\large 0};
		\end{tikzpicture}
		\caption{Der aktuell betrachtete Knoten wird orange dargestellt. \textsc{Relabel}$(v_1)$}
	\end{subfigure}
	\vskip\baselineskip	\begin{subfigure}{0.95\textwidth}
		\centering
		\begin{tikzpicture}
			\Vertex[label=$s$]{s}
			\Vertex[label=$v_1$, x=2, y=1, color=orange]{1}
		...
		\begin{tikzpicture}[scale=0.50]
			...
			\draw (4,5.5) node[anchor=south, text=red] {\large 0};
		\end{tikzpicture}
		\caption{Alle verfügbaren Push-Operationen werden ebenfalls markiert. \textsc{Push}$(v_1,t)$}
	\end{subfigure}
\end{figure}
\begin{figure}
	\ContinuedFloat
	...
	\vskip\baselineskip	\begin{subfigure}{0.95\textwidth}
		...
		\end{tikzpicture}
		\caption{\textsc{Relabel}$(v_2)$ ist wieder erlaubt, da $(v_2,t)\not\in E_f$}
	\end{subfigure}
\end{figure}
\begin{figure}
	\ContinuedFloat
    ...
    \begin{subfigure}{0.95\textwidth}
		...
		\begin{tikzpicture}[scale=0.50]
			...
			\draw (4,5.5) node[anchor=south, text=red] {\large 6};
		\end{tikzpicture}
		\caption{\textsc{Push}$(v_2,v_1)$. Die Push-Operation betrachtet Restkapazitäten, hier wird jedoch nur das Flussnetzwerk gezeigt.}
	\end{subfigure}
	\vskip\baselineskip	\begin{subfigure}{0.95\textwidth}
		\centering
		\begin{tikzpicture}
		...
		\begin{tikzpicture}[scale=0.50]
			...
			\draw (4,5.5) node[anchor=south, text=red] {\large 6};
		\end{tikzpicture}
		\caption{\textsc{Relabel}$(v_1)$ und \textsc{Push}$(v_1,v_2)$}
	\end{subfigure}
    \vskip\baselineskip	
	\begin{subfigure}{0.95\textwidth}
		\centering
		...
		\begin{tikzpicture}[scale=0.50]
			...
			\draw (4,5.5) node[anchor=south, text=red] {\large 6};
		\end{tikzpicture}
		\caption{\textsc{Relabel}$(v_2)$ und \textsc{Push}$(v_2,v_1)$}
	\end{subfigure}
	\vskip\baselineskip	\begin{subfigure}{0.95\textwidth}
		\centering
		\begin{tikzpicture}
		...
		\begin{tikzpicture}[scale=0.50]
			...
			\draw (4,5.5) node[anchor=south, text=red] {\large 6};
		\end{tikzpicture}
		\caption{\textsc{Relabel}$(v_1)$. Die Höhe von $v_1$ übersteigt $s.h$ und wir können den Flussüberschuss auflösen.}
	\end{subfigure}
\end{figure}
\begin{figure}
	\ContinuedFloat
	...
	\vskip\baselineskip	\begin{subfigure}{0.95\textwidth}
        ...
        \caption{Finale Konfiguration. 
                ...
                Offensichtlich gilt immer $\lvert f\rvert = - s.e$ für einen maximalen Fluss $f$.} %TODO
	\end{subfigure}
\end{figure}
